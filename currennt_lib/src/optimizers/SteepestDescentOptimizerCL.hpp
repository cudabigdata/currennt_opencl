...
#ifndef OPTIMIZERS_STEEPESTDESCENTOPTIMIZERCL_HPP
#define OPTIMIZERS_STEEPESTDESCENTOPTIMIZERCL_HPP
...
namespace optimizers {
    ...
    /******************************************************************************************//**
     * OptimizerCL that uses steepest descent
     *
     * @param TDevice The computation device (Cpu or Gpu)
     *********************************************************************************************/

    class SteepestDescentOptimizerCL : public OptimizerCL
    {
    ...
    private:
        ...
        std::vector<d_mem_real> m_weightDeltas;
    ...
    public:
         ...
         */
        virtual ~SteepestDescentOptimizerCL();

        /**
         * @see OptimizerCL::exportState
         */
        virtual void exportState(const helpers::JsonDocument &jsonDoc) const;

        /**
         * @see OptimizerCL::importState
         */
