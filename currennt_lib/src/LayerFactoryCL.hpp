...
#ifndef LAYER_FACTORYCL_HPP
#define LAYER_FACTORYCL_HPP

#include "layers/LayerCL.hpp"
...
public:
     ...
     */
    static layers::LayerCL* createLayerCL(
        const std::string        &layerType,
        const helpers::JsonValue &layerChild,
        const helpers::JsonValue &weightsSection,
        int                       parallelSequences, 
        int                       maxSeqLength,
        layers::LayerCL   *precedingLayerCL = NULL
        );
};
