...
#ifndef LAYERS_CEPOSTOUTPUTLAYERCL_HPP
#define LAYERS_CEPOSTOUTPUTLAYERCL_HPP
...
namespace layers {
    ...
    class CePostOutputLayerCL : public PostOutputLayerCL
    {
    public:
        /**
