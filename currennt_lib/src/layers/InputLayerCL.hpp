...
#ifndef LAYERS_INPUTLAYERCL_HPP
#define LAYERS_INPUTLAYERCL_HPP
...
namespace layers {
    ...
    class InputLayerCL : public LayerCL
    {
    public:
        /**
         ...
         */
        InputLayerCL(const helpers::JsonValue &layerChild, int parallelSequences, int maxSeqLength);

        /**
         * Destructs the LayerCL
         */
        virtual ~InputLayerCL();
