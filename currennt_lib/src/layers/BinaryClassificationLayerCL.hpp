...
#ifndef LAYERS_BINARYCLASSIFICATIONLAYERCL_HPP
#define LAYERS_BINARYCLASSIFICATIONLAYERCL_HPP
...
namespace layers {
    ...
    class BinaryClassificationLayerCL : public PostOutputLayerCL
    {
    public:
        /**
         ...
         */
        virtual ~BinaryClassificationLayerCL();
...
#endif // LAYERS_BINARYCLASSIFICATIONLAYERCL_HPP
