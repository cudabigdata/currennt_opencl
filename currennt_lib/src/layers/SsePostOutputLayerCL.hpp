...
#ifndef LAYERS_SSEPOSTOUTPUTLAYERCL_HPP
#define LAYERS_SSEPOSTOUTPUTLAYERCL_HPP
...
namespace layers {
    ...
    class SsePostOutputLayerCL : public PostOutputLayerCL
    {
    public:
        /**
...
#endif // LAYERS_SSEPOSTOUTPUTLAYERCL_HPP
