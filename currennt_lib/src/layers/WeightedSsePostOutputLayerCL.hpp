...
#ifndef LAYERS_WEIGHTEDSSEPOSTOUTPUTLAYERCL_HPP
#define LAYERS_WEIGHTEDSSEPOSTOUTPUTLAYERCL_HPP
...
namespace layers {
    ...
    class WeightedSsePostOutputLayerCL : public PostOutputLayerCL
    {
    public:
        /**
         ...
         */
        virtual ~WeightedSsePostOutputLayerCL();
...
#endif // LAYERS_WEIGHTEDSSEPOSTOUTPUTLAYERCL_HPP
