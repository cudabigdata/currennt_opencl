...
namespace {
    ...
    struct ComputeBlockOutputFn
    {
        ...
        const char *patTypes; //c

        const real_t *niBiasWeights; //C
        const real_t *igBiasWeights; //C
...
//        m_bw.niActsMatrix.TAM_print();
//        m_bw.igActsMatrix.TAM_print();
//        m_bw.fgActsMatrix.TAM_print();
//        m_bw.ogActsMatrix.TAM_print();
