...
#ifndef NeuralNetworkCL_HPP
#define NeuralNetworkCL_HPP
...
class NeuralNetworkCL
{
private:
    std::vector<boost::shared_ptr<layers::LayerCL > > m_layers;
...
public:
     ...
     */
    NeuralNetworkCL(const helpers::JsonDocument &jsonDoc, int parallelSequences, int maxSeqLength,
     ...
     * @return The layers
     */
    const std::vector<boost::shared_ptr<layers::LayerCL > >& layers() const;
     ...
     */
    layers::InputLayerCL& inputLayerCL();
     ...
     */
    layers::TrainableLayerCL& outputLayerCL();
     ...
     */
    layers::PostOutputLayerCL& postOutputLayerCL();
     ...
     */
    void loadSequences(const data_sets::DataSetFractionCL &fraction);
